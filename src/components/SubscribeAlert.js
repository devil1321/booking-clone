...
const Alert = ({icon,home,text,link,href,close}) => {
    const [isClosed,setIsClosed] = useState(false)
    return (
        <React.Fragment>
        {!isClosed &&
        <div className="subscribe-a">
            <div className="subscribe-a__content">
                ...
                <div className="subscribe-a__text">
            ...
            <div className="subscribe-a__close" onClick={()=>setIsClosed(true)}>
                <span></span>
                <span></span>
            </div>
        </div>}
